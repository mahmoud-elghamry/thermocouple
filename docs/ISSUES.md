...
| I-029 | medium | `docs/GOAL.md` R-7 says "Survive a motor/VFD panel and 50 m cable runs". There is no VFD - it is an engine, and the unit sits in its own panel 50 m away. GOAL.md is user-owned, so the correction needs the user's sign-off. |
